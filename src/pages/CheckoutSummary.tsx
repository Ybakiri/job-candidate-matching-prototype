        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex flex-col items-center">
            <div className="relative w-12 h-12">
              <img alt="" className="block max-w-none size-full" src={imgEllipse92} />
          ...
          <div className="flex flex-col items-center">
            <div className="relative w-12 h-12">
              <img alt="" className="block max-w-none size-full" src={imgEllipse93} />
            ...
            <div className="flex justify-end">
              ...
              >
                <div className="w-6 h-6">
                  <img alt="" className="block max-w-none size-full" src={imgSend} />
                </div>
