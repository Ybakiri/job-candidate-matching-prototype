      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="flex gap-4 items-center">
          ...
          <div className="flex-1 flex gap-3 items-start">
            ...
            <div className="flex items-center gap-3 shrink-0">
              ...
              >
                <img alt="View details" className="icon-lg" src={imgEye} />
              </button>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-5">
          ...
          <div className="border border-[#e6e6ea] rounded p-3">
            <h4 className="text-base font-bold text-[#202333] leading-6 mb-3">{t('candidates.pastExperiences')}</h4>
          ...
          <div className="flex gap-5">
            ...
            <div className="flex-1 border border-[#e6e6ea] rounded p-3">
              <h4 className="text-base font-bold text-[#202333] leading-6 mb-3">{t('candidates.education')}</h4>
              <div className="flex flex-col gap-2">
